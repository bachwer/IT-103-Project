...
function CalculationNutrition(food) {
    ...
    let fi = food.nutritionData.fiber.value
  ...
  `;
    uploadButton.onclick = () => {
        ...
        if (url && imagePreview.style.display !== 'none') {
            ...
            imgAdd(url);
            // Tạo sự kiện để thông báo URL ảnh cho các phần khác của ứng dụng
...
function validateRecipe() {
    ...
    // Kiểm tra nếu bất kỳ giá trị nào bị trống
